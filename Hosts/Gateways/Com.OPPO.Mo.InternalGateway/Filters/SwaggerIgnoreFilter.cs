...
namespace Com.OPPO.Mo.InternalGateway.Filters
{
    public class SwaggerIgnoreFilter : IDocumentFilter
    {
        ...
        public void Apply(OpenApiDocument swaggerDoc, DocumentFilterContext filterContext)
        {
            var ignoreApis = filterContext.ApiDescriptions
                .Where(x => ignoreControllerNames.Contains(x.ActionDescriptor.AsControllerActionDescriptor().ControllerName) || x.RelativePath.Contains("openapi"))
