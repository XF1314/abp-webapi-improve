...
using Com.OPPO.Mo.PermissionManagement.Web.Utils;

namespace Com.OPPO.Mo.PermissionManagement.Web.Pages.PermissionManagement
{
    public class PermissionManagementModal : AbpPageModel
    {
        ...
        {
            ObjectMapperContext = typeof(MoPermissionManagementWebModule);
