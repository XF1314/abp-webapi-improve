...
{
    public class MoTenantManagementPermissionDefinitionProvider : PermissionDefinitionProvider
    {
        ...
        {
            return LocalizableString.Create<MoTenantManagementResource>(name);
        }
    }
}
