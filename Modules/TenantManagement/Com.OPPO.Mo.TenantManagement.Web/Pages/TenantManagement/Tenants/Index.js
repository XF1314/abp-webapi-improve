(function () {
    ...
    var l = abp.localization.getResource('MoTenantManagement');
    var _tenantAppService = Com.OPPO.Mo.TenantManagement.tenant;
                    ...
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('MoTenantManagement.Tenants.Update'),
                                ...
                                },
	                            {
                                    ...
                                    visible: abp.auth.isGranted('MoTenantManagement.Tenants.ManageConnectionStrings'),
		                            action: function (data) {
                                ...
                                {
                                    text: l('Features'),
                                    visible: abp.auth.isGranted('MoTenantManagement.Tenants.ManageFeatures'),
                                    action: function (data) {
                                        _featuresModal.open({
                                            providerName: 'T',
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('MoTenantManagement.Tenants.Delete'),
