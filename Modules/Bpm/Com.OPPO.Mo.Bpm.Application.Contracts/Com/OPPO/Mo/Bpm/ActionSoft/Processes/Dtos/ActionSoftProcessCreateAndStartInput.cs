...
{
    /// <summary>
    /// ActionSoft流程创建并启动Input
    /// </summary>
    public class ActionSoftProcessCreateAndStartInput
    {
        /// <summary>
        /// <see cref="ActionSoftProcessCreateAndStartInput"/>
        /// </summary>
        public ActionSoftProcessCreateAndStartInput()
        {
        ...
        /// 【选填项】业务对象s
        /// </summary>
        public Dictionary<string, List<Dictionary<string, string>>> BusinessObjects { get; set; }
