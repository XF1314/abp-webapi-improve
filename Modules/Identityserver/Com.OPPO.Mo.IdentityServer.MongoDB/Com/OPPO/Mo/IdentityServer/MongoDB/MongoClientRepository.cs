...
{
    public class MongoClientRepository : MongoDbRepository<IMoIdentityServerMongoDbContext, Client, Guid>, IClientRepository
    {
        public MongoClientRepository(
            IMongoDbContextProvider<IMoIdentityServerMongoDbContext> dbContextProvider
            ) : base(
                dbContextProvider)
        {
        }
