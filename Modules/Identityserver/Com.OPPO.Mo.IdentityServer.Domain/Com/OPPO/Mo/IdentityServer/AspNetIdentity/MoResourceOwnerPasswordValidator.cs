...
{
    public class MoResourceOwnerPasswordValidator : IResourceOwnerPasswordValidator
    {
        ...
        protected IStringLocalizer<MoIdentityServerResource> Localizer { get; }

        public MoResourceOwnerPasswordValidator(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            IEventService events,
            ILogger<ResourceOwnerPasswordValidator<IdentityUser>> logger, 
            IStringLocalizer<MoIdentityServerResource> localizer)
        {
