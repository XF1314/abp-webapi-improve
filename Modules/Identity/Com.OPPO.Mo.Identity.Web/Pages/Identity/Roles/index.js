(function ($) {
    ...
    var _identityRoleAppService = com.oPPO.mo.identity.identityRole;
    var _permissionsModal = new abp.ModalManager(abp.appPath + 'PermissionManagement/PermissionManagementModal');
                    ...
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('MoIdentity.Roles.Update'),
                                ...
                                {
                                    text: l('Permissions'),
                                    visible: abp.auth.isGranted('MoIdentity.Roles.ManagePermissions'),
                                    action: function (data) {
                                ...
                                },
                                {
                                    ...
                                    visible: function (data) {
                                        return !data.isStatic && abp.auth.isGranted('MoIdentity.Roles.Delete'); //TODO: Check permission
                                    },
