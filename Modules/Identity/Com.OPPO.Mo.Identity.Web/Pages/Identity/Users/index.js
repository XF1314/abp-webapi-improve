                    ...
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('MoIdentity.Users.Update'),
                                ...
                                {
                                    text: l('Permissions'),
                                    visible: abp.auth.isGranted('MoIdentity.Users.ManagePermissions'),
                                    action: function (data) {
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('MoIdentity.Users.Delete'),
