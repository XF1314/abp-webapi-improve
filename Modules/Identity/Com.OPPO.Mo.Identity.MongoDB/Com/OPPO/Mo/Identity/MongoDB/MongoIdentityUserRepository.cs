...
{
    public class MongoIdentityUserRepository : MongoDbRepository<IMoIdentityMongoDbContext, IdentityUser, Guid>, IIdentityUserRepository
    {
        public MongoIdentityUserRepository(IMongoDbContextProvider<IMoIdentityMongoDbContext> dbContextProvider) 
