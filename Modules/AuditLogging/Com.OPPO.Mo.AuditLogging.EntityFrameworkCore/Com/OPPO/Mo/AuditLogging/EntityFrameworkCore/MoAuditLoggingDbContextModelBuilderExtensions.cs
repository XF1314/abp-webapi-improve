using System;
using Com.OPPO.Mo.Identity.EntityFrameworkCore;
...
{
    public static class MoAuditLoggingDbContextModelBuilderExtensions
    {
        public static void ConfigureAuditLogging(
            [NotNull] this ModelBuilder builder,
            Action<MoAuditLoggingModelBuilderConfigurationOptions> optionsAction = null)
        {
            Check.NotNull(builder, nameof(builder));

            var options = new MoAuditLoggingModelBuilderConfigurationOptions(
                MoAuditLoggingDbProperties.DbTablePrefix,
                MoAuditLoggingDbProperties.DbSchema
            );
