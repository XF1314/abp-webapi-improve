...
namespace Com.OPPO.Mo.Thirdparty.DataGrand.Requests
{
    ...
    /// 达观搜索权限查询请求模型
    /// </summary>
    public class DataGrandPermissionQueryRequest : ISignatureBasedDataGrandRequest, IAppIdInfo
    {
        /// <summary>
        /// <see cref="DataGrandPermissionQueryRequest"/>
        /// </summary>
        public DataGrandPermissionQueryRequest()
        {
