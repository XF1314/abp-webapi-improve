...
namespace Com.OPPO.Mo.Thirdparty.DataGrand.Requests
{
    ...
    /// 基础达能搜索提示词Request
    /// </summary>
    public abstract class BaseDataGrandSuggestionRequest : ISignatureBasedDataGrandRequest,IAppIdInfo
    {
        /// <summary>
        /// <see cref="BaseDataGrandSuggestionRequest"/>
        /// </summary>
        public BaseDataGrandSuggestionRequest()
        {
