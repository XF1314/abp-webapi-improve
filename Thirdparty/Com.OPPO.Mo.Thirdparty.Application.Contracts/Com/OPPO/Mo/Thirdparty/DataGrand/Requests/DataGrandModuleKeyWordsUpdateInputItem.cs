...
{
    /// <summary>
    /// 达观搜索模块关键字更新InputItem
    /// </summary>
    public class DataGrandModuleKeywordsUpdateInputItem : BaseDataGrandDataInputItem
    {
        /// <summary>
        /// <see cref="DataGrandModuleKeywordsUpdateInputItem"/>
        /// </summary>
        public DataGrandModuleKeywordsUpdateInputItem() : base(MO2DataGrandDataCategory.module)
        {
