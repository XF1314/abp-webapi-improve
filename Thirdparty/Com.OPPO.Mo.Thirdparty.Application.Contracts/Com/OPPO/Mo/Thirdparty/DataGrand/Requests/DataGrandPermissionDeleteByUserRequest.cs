...
namespace Com.OPPO.Mo.Thirdparty.DataGrand.Requests
{
    ...
    /// 达观搜索按用户删除权限请求模型
    /// </summary>
    public class DataGrandPermissionDeleteByUserRequest : ISignatureBasedDataGrandRequest, IAppIdInfo
    {
        /// <summary>
        /// <see cref="DataGrandPermissionDeleteByUserRequest"/>
        /// </summary>
        public DataGrandPermissionDeleteByUserRequest()
        {
        ...
        /// </summary>
        [JsonProperty("users")]
        public string Users { get { return JsonConvert.SerializeObject(UserCodes); } }
