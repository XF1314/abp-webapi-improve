...
namespace Com.OPPO.Mo.Thirdparty.Feiheair.Dtos
{
    ...
    /// </summary>
    [Serializable]
    public class FeiHeairOrderInfo
    {
        public FeiHeairOrderInfo()
        {
            OrderDatas = new List<FeiHeairOrderDataInfo>();
        }
        /// <summary>
        /// 错误代码(0表示成功，其它为失败)
        /// </summary>
        ...
        public List<FeiHeairOrderDataInfo> OrderDatas { get; set; }
    ...
    /// 订单数据列表
    /// </summary>
    public class FeiHeairOrderDataInfo
    {
        public FeiHeairOrderDataInfo()
        {
            Tickets = new List<FeiHeairTicketsItemInfo>();
            Policys = new List<FeiHeairPolicysItemInfo>();
        }
        ...
        /// 申请单号
        /// </summary>
        [JsonProperty("applicationDh")]
        public string ApplicationDh { get; set; }

        /// <summary>
        /// 关联订单号
        /// </summary>
        [JsonProperty("Order_ID_ref")]
        ...
        /// 保险人
        /// </summary>
        [JsonProperty("insurancePerson")]
        public string InsurancePerson { get; set; }

        /// <summary>
        /// 飞机乘机人列表
        /// </summary>
        public List<FeiHeairTicketsItemInfo> Tickets { get; set; }
        /// <summary>
        /// 违反差旅政策列表
        /// </summary>
        public List<FeiHeairPolicysItemInfo> Policys { get; set; }
    ...
    /// 飞机乘机人列表
    /// </summary>
    public class FeiHeairTicketsItemInfo
    {
        /// <summary>
        /// ?
        /// </summary>
    ...
    /// 违反差旅政策列表
    /// </summary>
    public class FeiHeairPolicysItemInfo
    {
        /// <summary>
        /// ?
        /// </summary>
