...
{
    //public class JmsParamsSignatureFilter : ApiActionFilterAttribute
    //{
    //    private readonly Lazy<IConfiguration> _configuration;
    //    private readonly Lazy<ILoggerFactory> _loggerFactory;

    //    public JmsParamsSignatureFilter(Lazy<ILoggerFactory> loggerFactory, Lazy<IConfiguration> configuration)
    //    {
    ...
    //                && apiActionContext.ApiActionDescriptor.Parameters[0].Value is ISignatureBasedJmsRequest)
    //            {
    ...
    //                        appIdInfo.AppId = _configuration.Value[ThirdpartySettingNames.JmsAppId];
    ...
    //        var jmsSignKey = _configuration.Value[ThirdpartySettingNames.JmsAppId];
    ...
    //                var sign = GetSignature(@params, apiPath, jmsSignKey);
    //                @params.Add(nameof(ISignatureBasedJmsRequest.Sign), sign);
    ...
    //                var sign = GetSignature(@params, apiPath, jmsSignKey);
    //                jObject.Add(nameof(ISignatureBasedJmsRequest.Sign), sign);
    //                apiActionContext.RequestMessage.Content.Dispose();
    ...
    //            uriEditor.AddQuery(nameof(ISignatureBasedJmsRequest.Sign), sign);
